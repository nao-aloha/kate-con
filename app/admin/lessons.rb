ActiveAdmin.register Lesson do
	...
	permit_params :company_name, :name, :name, :fee, :lesson_purpose_id, :lesson_purpose_name,  company_lesson_purposes_attributes: [:id, :lesson_purpose, :company_lesson_purposes_id, :_destroy]	
